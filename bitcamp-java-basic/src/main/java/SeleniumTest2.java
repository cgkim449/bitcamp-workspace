...
public class SeleniumTest2 {
  public static void main(String... args) {
    ...
    try {
      ...
      // String str = t_element.findElement(By.cssSelector("#photoTypeGroup
      // li[imagetype=\'STILLCUT\']")).findElement(By.tagName("em")).getText();
  ...
  public static WebElement crawl(WebElement t_element) {
    ...
    // 스틸컷 8장의 태그를 리스트에 담음
    List<WebElement> e_list =
        element.findElement(By.className("list_area")).findElements(By.tagName("a"));
    ...
    for (WebElement e : e_list) {
      ...
      String str = t_element.findElement(By.className("viewer_img")).findElement(By.tagName("img"))
          .getAttribute("src");
      // 포토 이미지의 url을 출력함
