...
// 문자열을 보내고 싶으면 문자열에서 바이트 배열을 뽑아라

// 세번째 파라미터 SocketAddress는 추상 클래스다
// = 인스턴스를 못만든다
// SocketAddress의 서브클래스 객체가 올  수 있다
// 그래서 new InetAddress() 했는데 생성자가 not visible
// 그럼 둘중하나다 factory method, factory class
// factory method부터 찾아봐라
// static 메서드에서 찾아라
// 예) Calendar의 getInstance()
// 예) factory class의 예 : StringBuilder의
