...
// => 다음과 같이 한 개의 점이 있다.
//    10001100 10010010 10101100 (변경전 색)
//  & 11111011 11111101 11111111 (빨강,초록 약화시키기)
// -------------------------------
...
//      빛이 없는 점은 빛을 넣는다
//
//=> 다음과 같이 흑색의 한 개의 점이 있다.
// 00000000 00000000 00000000 (변경전 색)
//~ 11111111 11111111 11111111
//-------------------------------
// 11111111 11111111 11111111 (변견한 색)

//비트 연산 활용 예4:
//=> 필터 만들기
//=> 방법: 
//    ^연산자를 사용하여 특정색상만 제거할 수 있다.
//
//=> 다음과 같이 비트데이터가 있다.
//11001010 11100100 00111001(제거하려는 색상)
//^ 11001010 11100100 00111001 
//-------------------------------
//00000000 000000000 00000000 

// 1920 *1080 = 2,073,600 픽셀 (2백만 화소)
//
// 1픽셀 = 3byte
// 16,777,216 색상
// 2,073,600픽셀*3byte = 6,228,900 byte = 6,082KB = 5.94MB full hd
//
// 1000만화소 카메라 10,000,000*3 = 30,000,000 = 29,296KB = 28.6MB(사진 한장) (raw data file)
// 손실압축 : JPEG : 많이 저장할 수 있으나 원래 이미지로 원상복구가 불가능하다
// 무손실압축 : GIF : 압축률이 낮
// 
// 80분 영화 (영화는 초당 24장 사진) full hd
// 80분*60초*24장 = 115,200장
// = 115,200 *6MB = 691,200MB = 675GB ==> 4GB(손실압축, MPEG)
