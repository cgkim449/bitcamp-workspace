...
public class Exam0130 {
  public static void main(String[] args) {
    ...
    b = 5 + 6; // 최적화(optimizing) : 기계어를 줄이기위해? 컴파일하면 b = 11;
    ...
    // z = x + y; // 컴파일 오류! // 컴파일러는 이 문장을 번역할때 x, y에 뭐가 들어있는지 따지지않는다
    // 문장문장을 기계어로 바꿀뿐, 문장을 기계어로 바꿀수있느냐만 관심
    // x+y가 z에 들어갈수 없을수도 있기 때문에
