...
public class Exam0210 {
  public static void main(String[] args) {
    // 2. 자바는 primitive data type의 값을 다룰 때 기본 연산자 외에
    // 좀 더 다양한 방법으로 다루기 위해
    ...
    // String 처럼 같은 값을 가지면 같은 주소를 갖게하고싶다
  }
  ...
  // 1. 만약에 Wrapper 클래스가 없다면 다음과 같이 정수를 받는 메서드와 부동소수점을 받는 메서드
  // 논리값을 받는 메서드를 따로 따로 정의해야한다
  // => 이런 불편함을 없애기 위해 Wrapper 클래스를 만든 것이다
  // => 즉 primitive type을 객체와 함께 다룰 수 있도록 만든 문법이다

  void m(int value) {
    System.out.printf("value = %s\n", value);
  } // byte, short, int, long, char 받을 수 있다
