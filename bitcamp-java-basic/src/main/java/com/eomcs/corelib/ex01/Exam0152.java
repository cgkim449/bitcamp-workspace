...
// HashMap : key 객체의 해쉬값으로 중복여부 검사,
// 마찬가지로 객체 내용물이 같으면 같은 key라고 하고 싶기 때문에 haschcode(), equals()를 오버라이딩하자
...
public class Exam0152 {
  ...
  public static void main(String[] args) {
    ...
    map.put(k1, new Student("홍길동", 20, false)); // key 객체, key로 저장할 객체
    ...
    // 두 키 객체 k3와 k6이 내용물이 같다 하더라도, (둘다 "haha"이다.)
