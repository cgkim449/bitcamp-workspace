// hash code 응용 - 문제 해결!
// 해시셋은 해시값으로 중복여부를 검사한다, 셋은 중복저장을 안한다
// 그래서 인스턴스의 내용물이 같은 인스턴스들은 해시값을 갖게 하고 싶다
// 해결책 : Student 클래스에서 hashcode()를 오버라이딩하자

// 해쉬셋은 내용물도 보고 해쉬코드도 봄(equal(), hashcode())
...
public class Exam0151 {
  ...
  public static void main(String[] args) {
    ...
    // 해시셋에 보관된 객체를 꺼낸다.
    Object[] list = set.toArray(); // 배열에 담아서 배열 주소를 리턴
    for (Object obj : list) {
