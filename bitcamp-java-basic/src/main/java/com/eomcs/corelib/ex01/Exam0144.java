...
// 두개의 인스턴스가 같다는 것은 내용물이 같고, 해쉬코드가 같을때이다
// equals()는 내용물이 같은지 비교하게 오버라이딩한다 (원래Object의 equals()는 주소)
// 내용물이 같으면 같은 해쉬코드를 갖게하기 위해 해쉬코드를 오버라이딩한다(원래Object의 hashcode() 고유 해쉬코드)
