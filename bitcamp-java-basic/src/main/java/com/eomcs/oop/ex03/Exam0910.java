...
public class Exam0910 {
  ...
  public static void main(String[] args) {
    ...
    // 모니터의 중요 필드 값을 초기화시키지 않고 사용하면 제대로 동작이 안될 수 있다
    ...
    // 그래야 모니터의 기능을 제대로 사용할 수 있다

    // 다음은 모니터 인스턴스를 만든 후 에 모니터 인슨턴스를 사용하는 사용자가
    ...
    m1.display();
    // 고객의 의견!
    // => 모니터를 구매한 후 바로 사용할 수 있ㄷ록 모니터의 속성 값들이 유효한 값으로 미리
    // 초기화 되었으면 좋겠습니다!
