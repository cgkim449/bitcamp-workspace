// 다형성 - 다형적 변수의 형변환 응용 - type casting과 instanceof 연산자
// 한개의 메서드!만으로, 각각의 클래스의 모든 인스턴스 필드를 출력

// 형변환과 instanceof를 사용하면 공통된 인스턴스 필드까지만이아닌
// 각각의 전제 인스턴스 필드를 다룰 수 있다
...
public class Exam0521 {
  ...
  public static void print(Vehicle v) {
    ...
    // 일단 여기까지가 앞에서 한거다 여기까지 밖에 안되는줄알았다
    // 그런데 형변환이랑 instanceof를 사용하면 더 할 수 있다
